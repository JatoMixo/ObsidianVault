...
- Stores an N-Byte ID without encryption or authentication that can be cloned easily.
- It's also important to notice that the fucking ID of the card is usually written on it and can be just read and copied without any fancy embedded stuff.
